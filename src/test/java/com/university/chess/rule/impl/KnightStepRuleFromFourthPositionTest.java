...
public class KnightStepRuleFromFourthPositionTest {

    private final KnightStepRule underTest = new KnightStepRuleFromFourthPosition();
    ...
    private static Stream<FieldPosition> positiveCases() {
        return Stream.of(new FieldPosition(0,2), new FieldPosition(2, 2));
    }
