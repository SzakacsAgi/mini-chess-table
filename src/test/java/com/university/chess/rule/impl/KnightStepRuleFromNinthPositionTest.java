...
public class KnightStepRuleFromNinthPositionTest {

    private final KnightStepRule underTest = new KnightStepRuleFromNinthPosition();
    ...
    private static Stream<FieldPosition> positiveCases() {
        return Stream.of(new FieldPosition(0,1), new FieldPosition(1, 0));
    }
