...
public class KnightStepRuleFromSecondPositionTest {

    private final KnightStepRule underTest = new KnightStepRuleFromSecondPosition();
    ...
    private static Stream<FieldPosition> positiveCases() {
        return Stream.of(new FieldPosition(2,0), new FieldPosition(2, 2));
    }
