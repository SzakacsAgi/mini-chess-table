...
public class KnightStepRuleFromSeventhPositionTest {

    private final KnightStepRule underTest = new KnightStepRuleFromSeventhPosition();
    ...
    private static Stream<FieldPosition> positiveCases() {
        return Stream.of(new FieldPosition(0,1), new FieldPosition(1, 2));
    }
