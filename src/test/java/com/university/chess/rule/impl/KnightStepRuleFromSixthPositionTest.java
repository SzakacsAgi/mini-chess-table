...
public class KnightStepRuleFromSixthPositionTest {

    private final KnightStepRule underTest = new KnightStepRuleFromSixthPosition();
    ...
    private static Stream<FieldPosition> positiveCases() {
        return Stream.of(new FieldPosition(0,0), new FieldPosition(2, 0));
    }
