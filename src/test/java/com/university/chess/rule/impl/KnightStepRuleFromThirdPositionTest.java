...
public class KnightStepRuleFromThirdPositionTest {

    private final KnightStepRule underTest = new KnightStepRuleFromThirdPosition();
    ...
    private static Stream<FieldPosition> positiveCases() {
        return Stream.of(new FieldPosition(1,0), new FieldPosition(2, 1));
    }
